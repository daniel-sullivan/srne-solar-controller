...
var Statistics = Group{
	...
	Registers: []Register{
		...
		{Address: AddrAccumMainsCharge, Name: "Accumulated Mains Charge", Scale: Mul1, Unit: "AH", Type: U32, Access: ReadOnly, Count: 2},
		{Address: AddrAccumEnergyImport, Name: "Accumulated Energy Import", Scale: Mul01, Unit: "kWh", Type: U32, Access: ReadOnly, Count: 2, Optional: true},
